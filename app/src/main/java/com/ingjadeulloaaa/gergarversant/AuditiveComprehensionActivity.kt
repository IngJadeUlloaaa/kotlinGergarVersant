...
class AuditiveComprehensionActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_auditive_comprehension)

        textToSpeech = TextToSpeech(this, this)
        voiceGraphView = findViewById(R.id.voiceGraph)

        val startRecordingButton: ImageButton = findViewById(R.id.startRecordingButton)
    ...
    private fun startRecording() {
        File(cacheDir, "audio.mp3").also {
            recorder.start(it)
            audioFile = it
            findViewById<ImageButton>(R.id.startRecordingButton).visibility = View.GONE
            findViewById<ImageButton>(R.id.stopRecordingButton).visibility = View.VISIBLE
        }
    }
    ...
    private fun createAudioModalDialog(context: Context, file: File?) {
        if (file != null) {
            ...
            val restartTextView =
                dialogView.findViewById<TextView>(R.id.restartTextView) // Aquí está tu botón Restart
            ...
            val restartAllTextView: TextView = dialogView.findViewById(R.id.restartAllButton)
            ...
            restartAllTextView.setOnClickListener {
                dialog.dismiss()
                restartAll()
            }
            ...
            if (currentStoryIndex == stories.size - 1) {
                ...
                restartAllTextView.visibility = View.VISIBLE
            } else {
                continueTextView.visibility = View.VISIBLE
                restartAllTextView.visibility = View.GONE
            }
    ...
    override fun onInit(status: Int) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                ...
                findViewById<ImageButton>(R.id.startRecordingButton).isEnabled = true
